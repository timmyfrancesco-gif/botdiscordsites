...
function ProductCard({
  ...
  const cardInner = (
    <motion.div
      ...
      className={`group shine-card spotlight relative flex flex-col overflow-hidden bg-background-elevated transition-colors duration-300 hover:brightness-110 ${
        isBestSeller
