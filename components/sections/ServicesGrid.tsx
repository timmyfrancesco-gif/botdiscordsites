  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Glow halos */}
        <span className="pointer-events-none absolute -bottom-[110px] -left-[90px] h-[260px] w-[260px] rounded-full bg-[radial-gradient(circle,rgba(237,58,65,0.15),transparent_60%)] blur-[44px] opacity-30 transition-transform duration-300 group-hover:-translate-y-1" />
