...
import Football from "@/components/casino/Football";

export const metadata: Metadata = {
  title: "Scommesse Calcio — Dshop Casino",
    ...
    <PageShell>
      <section className="px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-lg">
          ...
          <h1 className="mb-6 text-2xl font-black text-foreground">Scommesse Calcio</h1>
          <Football />
        </div>
      </section>
    </PageShell>
